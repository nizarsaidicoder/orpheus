import type { ScaleCategory, ScalePattern } from "./scale.js";
import { MAJOR_PATTERN, NATURAL_MINOR_PATTERN, HARMONIC_MINOR_PATTERN, MELODIC_MINOR_PATTERN, HARMONIC_MAJOR_PATTERN } from "./diatonic.js";
import { IONIAN_PATTERN, DORIAN_PATTERN, PHRYGIAN_PATTERN, LYDIAN_PATTERN, MIXOLYDIAN_PATTERN, AEOLIAN_PATTERN, LOCRIAN_PATTERN } from "./modes.js";
import { WHOLE_TONE_PATTERN, DIMINISHED_HW_PATTERN, DIMINISHED_WH_PATTERN, AUGMENTED_PATTERN } from "./symmetric.js";
import {
...
const BUILT_IN_PATTERNS: ReadonlyArray<ScalePattern> = Object.freeze([
  ...
  MELODIC_MINOR_PATTERN, HARMONIC_MAJOR_PATTERN,
  // Church modes
